...
grep -h '^JNIEXPORT .* Java_' /home/tgs1003/JikesRVM-3.1.4/components/classpath/99p16/classpath/include/*.h | \
...
find /home/tgs1003/JikesRVM-3.1.4/components/classpath/99p16/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/tgs1003/JikesRVM-3.1.4/components/classpath/99p16/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/tgs1003/JikesRVM-3.1.4/components/classpath/99p16/classpath/native/jni -name \*.cpp | \
